...
T = TypeVar("T", bound="ProjectEventMeetingAddEditModel")


@_attrs_define
class ProjectEventMeetingAddEditModel:
    """
    Attributes:
        title (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_event_meeting_add_edit_model = cls(
            title=title,
        ...
        return project_event_meeting_add_edit_model
