...
if TYPE_CHECKING:
    ...
    from ..models.dynamic_template_view_model import DynamicTemplateViewModel
    from ..models.link import Link
    from ..models.updated_model import UpdatedModel


T = TypeVar("T", bound="DynamicCompanyUserResumeModel")


@_attrs_define
class DynamicCompanyUserResumeModel:
    """
    Attributes:
        ...
        resume (Union[Unset, None, DynamicTemplateViewModel]):
    ...
    resume: Union[Unset, None, "DynamicTemplateViewModel"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _resume is None:
            ...
            resume = DynamicTemplateViewModel.from_dict(_resume)
        ...
        dynamic_company_user_resume_model = cls(
            image_id=image_id,
        ...
        return dynamic_company_user_resume_model
