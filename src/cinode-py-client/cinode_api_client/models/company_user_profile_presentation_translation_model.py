...
T = TypeVar("T", bound="CompanyUserProfilePresentationTranslationModel")


@_attrs_define
class CompanyUserProfilePresentationTranslationModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        company_user_profile_presentation_translation_model = cls(
            title=title,
        ...
        return company_user_profile_presentation_translation_model
