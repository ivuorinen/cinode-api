...
T = TypeVar("T", bound="CompanyUserProfileExtSkillTranslationModel")


@_attrs_define
class CompanyUserProfileExtSkillTranslationModel:
    """
    Attributes:
        profile_ext_skill_id (Union[Unset, None, int]):
    ...
    profile_ext_skill_id: Union[Unset, None, int] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        profile_ext_skill_id = self.profile_ext_skill_id
        title = self.title
        ...
        field_dict.update({})
        if profile_ext_skill_id is not UNSET:
            field_dict["profileExtSkillId"] = profile_ext_skill_id
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        profile_ext_skill_id = d.pop("profileExtSkillId", UNSET)
        ...
        company_user_profile_ext_skill_translation_model = cls(
            profile_ext_skill_id=profile_ext_skill_id,
            title=title,
        ...
        return company_user_profile_ext_skill_translation_model
