...
T = TypeVar("T", bound="CompanyCandidateFileAttachmentModel")


@_attrs_define
class CompanyCandidateFileAttachmentModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        company_candidate_file_attachment_model = cls(
            file_name=file_name,
            extension=extension,
            id=id,
        ...
        return company_candidate_file_attachment_model
