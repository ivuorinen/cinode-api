...
T = TypeVar("T", bound="CompanyCandidateEventMeetingModel")


@_attrs_define
class CompanyCandidateEventMeetingModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        company_candidate_event_meeting_model = cls(
        ...
        return company_candidate_event_meeting_model
