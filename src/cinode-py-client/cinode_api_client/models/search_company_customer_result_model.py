...
T = TypeVar("T", bound="SearchCompanyCustomerResultModel")


@_attrs_define
class SearchCompanyCustomerResultModel:
    """
    Attributes:
        paged_and_sorted_by (Union[Unset, None, CompanyCustomerQuerySortPageAndSortByModel]):
        result (Union[Unset, None, List['CompanyCustomerBaseModel']]):
        hits (Union[Unset, int]):
        total_items (Union[Unset, int]):
    """

    paged_and_sorted_by: Union[Unset, None, "CompanyCustomerQuerySortPageAndSortByModel"] = UNSET
    result: Union[Unset, None, List["CompanyCustomerBaseModel"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _paged_and_sorted_by is None:
            ...
            paged_and_sorted_by = CompanyCustomerQuerySortPageAndSortByModel.from_dict(_paged_and_sorted_by)

        result = []
        _result = d.pop("result", UNSET)
        for result_item_data in _result or []:
            result_item = CompanyCustomerBaseModel.from_dict(result_item_data)
        ...
        search_company_customer_result_model = cls(
        ...
        return search_company_customer_result_model
