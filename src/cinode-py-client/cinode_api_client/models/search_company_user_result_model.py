...
T = TypeVar("T", bound="SearchCompanyUserResultModel")


@_attrs_define
class SearchCompanyUserResultModel:
    """
    Attributes:
        paged_and_sorted_by (Union[Unset, None, CompanyUserQuerySortPageAndSortByModel]):
        result (Union[Unset, None, List['CompanyUserExtendedModel']]):
        hits (Union[Unset, int]):
        total_items (Union[Unset, int]):
    """

    paged_and_sorted_by: Union[Unset, None, "CompanyUserQuerySortPageAndSortByModel"] = UNSET
    result: Union[Unset, None, List["CompanyUserExtendedModel"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _paged_and_sorted_by is None:
            ...
            paged_and_sorted_by = CompanyUserQuerySortPageAndSortByModel.from_dict(_paged_and_sorted_by)

        result = []
        _result = d.pop("result", UNSET)
        for result_item_data in _result or []:
            result_item = CompanyUserExtendedModel.from_dict(result_item_data)
        ...
        search_company_user_result_model = cls(
        ...
        return search_company_user_result_model
