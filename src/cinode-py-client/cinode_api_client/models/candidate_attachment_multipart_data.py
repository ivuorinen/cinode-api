...
T = TypeVar("T", bound="CandidateAttachmentMultipartData")


@_attrs_define
class CandidateAttachmentMultipartData:
    """
    Attributes:
        files (List[File]):
        title (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        candidate_attachment_multipart_data = cls(
            files=files,
            title=title,
            description=description,
        )

        candidate_attachment_multipart_data.additional_properties = d
