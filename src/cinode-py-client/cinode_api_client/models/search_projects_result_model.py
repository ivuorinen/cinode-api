...
T = TypeVar("T", bound="SearchProjectsResultModel")


@_attrs_define
class SearchProjectsResultModel:
    """
    Attributes:
        paged_and_sorted_by (Union[Unset, None, ProjectQuerySortPageAndSortByModel]):
        result (Union[Unset, None, List['ProjectBaseModel']]):
        hits (Union[Unset, int]):
        total_items (Union[Unset, int]):
    """

    paged_and_sorted_by: Union[Unset, None, "ProjectQuerySortPageAndSortByModel"] = UNSET
    result: Union[Unset, None, List["ProjectBaseModel"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _paged_and_sorted_by is None:
            ...
            paged_and_sorted_by = ProjectQuerySortPageAndSortByModel.from_dict(_paged_and_sorted_by)

        result = []
        _result = d.pop("result", UNSET)
        for result_item_data in _result or []:
            result_item = ProjectBaseModel.from_dict(result_item_data)
        ...
        search_projects_result_model = cls(
        ...
        return search_projects_result_model
