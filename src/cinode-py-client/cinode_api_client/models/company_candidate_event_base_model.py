...
T = TypeVar("T", bound="CompanyCandidateEventBaseModel")


@_attrs_define
class CompanyCandidateEventBaseModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        company_candidate_event_base_model = cls(
        ...
        return company_candidate_event_base_model
