...
T = TypeVar("T", bound="CompanyResumeTemplateLanguageModel")


@_attrs_define
class CompanyResumeTemplateLanguageModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        company_resume_template_language_model = cls(
        ...
        return company_resume_template_language_model
