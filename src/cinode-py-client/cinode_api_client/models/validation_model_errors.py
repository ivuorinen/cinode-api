...
T = TypeVar("T", bound="ValidationModelErrors")
...
class ValidationModelErrors:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        validation_model_errors.additional_properties = additional_properties
        return validation_model_errors
