...
if TYPE_CHECKING:
    from ..models.work_experience_block_item_model import WorkExperienceBlockItemModel


T = TypeVar("T", bound="WorkExperienceBlockModel")


@_attrs_define
class WorkExperienceBlockModel:
    """
    Attributes:
        skills_heading (Union[Unset, None, str]):
        ...
        data (Union[Unset, None, List['WorkExperienceBlockItemModel']]):
        block_id (Union[Unset, str]):
        updated (Union[Unset, None, datetime.datetime]):
        heading (Union[Unset, None, str]):
    """

    skills_heading: Union[Unset, None, str] = UNSET
    ...
    use_logotype: Union[Unset, bool] = UNSET
    data: Union[Unset, None, List["WorkExperienceBlockItemModel"]] = UNSET
    block_id: Union[Unset, str] = UNSET
    updated: Union[Unset, None, datetime.datetime] = UNSET
    heading: Union[Unset, None, str] = UNSET

    def to_dict(self) -> Dict[str, Any]:
        skills_heading = self.skills_heading
        ...
        use_logotype = self.use_logotype
        ...
        field_dict.update({})
        if skills_heading is not UNSET:
            field_dict["skillsHeading"] = skills_heading
        ...
        if use_logotype is not UNSET:
            field_dict["useLogotype"] = use_logotype
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        skills_heading = d.pop("skillsHeading", UNSET)
        ...
        use_logotype = d.pop("useLogotype", UNSET)

        data = []
        _data = d.pop("data", UNSET)
        for data_item_data in _data or []:
            data_item = WorkExperienceBlockItemModel.from_dict(data_item_data)
        ...
        work_experience_block_model = cls(
        ...
        return work_experience_block_model
