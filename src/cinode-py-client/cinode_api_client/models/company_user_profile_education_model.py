...
if TYPE_CHECKING:
    from ..models.company_user_profile_education_translation_model import CompanyUserProfileEducationTranslationModel
    from ..models.link import Link


T = TypeVar("T", bound="CompanyUserProfileEducationModel")


@_attrs_define
class CompanyUserProfileEducationModel:
    """
    Attributes:
        ...
        translations (Union[Unset, None, List['CompanyUserProfileEducationTranslationModel']]):
    ...
    translations: Union[Unset, None, List["CompanyUserProfileEducationTranslationModel"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.company_user_profile_education_translation_model import (
        ...
        for translations_item_data in _translations or []:
            translations_item = CompanyUserProfileEducationTranslationModel.from_dict(translations_item_data)
        ...
        company_user_profile_education_model = cls(
        ...
        return company_user_profile_education_model
