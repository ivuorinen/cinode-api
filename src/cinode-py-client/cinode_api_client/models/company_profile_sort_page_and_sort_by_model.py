...
from ..models.company_profile_sort import CompanyProfileSort
from ..models.sort_order import SortOrder
from ..types import UNSET, Unset

T = TypeVar("T", bound="CompanyProfileSortPageAndSortByModel")


@_attrs_define
class CompanyProfileSortPageAndSortByModel:
    """
    Attributes:
        sort_by (Union[Unset, CompanyProfileSort]): 0 - Id (Default),
            1 - CompanyUserId,
            2 - CreatedDateTime,
            3 - UpdatedDateTime
    ...
    sort_by: Union[Unset, CompanyProfileSort] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_by: Union[Unset, CompanyProfileSort]
        if isinstance(_sort_by, Unset):
            sort_by = UNSET
        else:
            sort_by = CompanyProfileSort(_sort_by)
        ...
        company_profile_sort_page_and_sort_by_model = cls(
            sort_by=sort_by,
        ...
        return company_profile_sort_page_and_sort_by_model
