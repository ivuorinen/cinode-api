...
from ..models.company_customer_query_sort import CompanyCustomerQuerySort
from ..models.sort_order import SortOrder
from ..types import UNSET, Unset

T = TypeVar("T", bound="CompanyCustomerQuerySortPageAndSortByModel")


@_attrs_define
class CompanyCustomerQuerySortPageAndSortByModel:
    """
    Attributes:
        sort_by (Union[Unset, CompanyCustomerQuerySort]):
    ...
    sort_by: Union[Unset, CompanyCustomerQuerySort] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_sort_by, Unset):
            ...
            sort_by = CompanyCustomerQuerySort(_sort_by)
        ...
        company_customer_query_sort_page_and_sort_by_model = cls(
            sort_by=sort_by,
        ...
        return company_customer_query_sort_page_and_sort_by_model
