...
from ..models.company_candidate_query_sort import CompanyCandidateQuerySort
from ..models.sort_order import SortOrder
from ..types import UNSET, Unset

T = TypeVar("T", bound="CompanyCandidateQuerySortPageAndSortByModel")


@_attrs_define
class CompanyCandidateQuerySortPageAndSortByModel:
    """
    Attributes:
        sort_by (Union[Unset, CompanyCandidateQuerySort]):
    ...
    sort_by: Union[Unset, CompanyCandidateQuerySort] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_sort_by, Unset):
            ...
            sort_by = CompanyCandidateQuerySort(_sort_by)
        ...
        company_candidate_query_sort_page_and_sort_by_model = cls(
            sort_by=sort_by,
        ...
        return company_candidate_query_sort_page_and_sort_by_model
