...
T = TypeVar("T", bound="CompanyCandidateUriAttachmentModel")


@_attrs_define
class CompanyCandidateUriAttachmentModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        company_candidate_uri_attachment_model = cls(
            uri=uri,
            id=id,
        ...
        return company_candidate_uri_attachment_model
