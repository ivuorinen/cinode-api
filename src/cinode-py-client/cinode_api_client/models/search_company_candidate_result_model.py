...
T = TypeVar("T", bound="SearchCompanyCandidateResultModel")


@_attrs_define
class SearchCompanyCandidateResultModel:
    """
    Attributes:
        paged_and_sorted_by (Union[Unset, None, CompanyCandidateQuerySortPageAndSortByModel]):
        result (Union[Unset, None, List['CompanyCandidateBaseModel']]):
        hits (Union[Unset, int]):
        total_items (Union[Unset, int]):
    """

    paged_and_sorted_by: Union[Unset, None, "CompanyCandidateQuerySortPageAndSortByModel"] = UNSET
    result: Union[Unset, None, List["CompanyCandidateBaseModel"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _paged_and_sorted_by is None:
            ...
            paged_and_sorted_by = CompanyCandidateQuerySortPageAndSortByModel.from_dict(_paged_and_sorted_by)

        result = []
        _result = d.pop("result", UNSET)
        for result_item_data in _result or []:
            result_item = CompanyCandidateBaseModel.from_dict(result_item_data)
        ...
        search_company_candidate_result_model = cls(
        ...
        return search_company_candidate_result_model
