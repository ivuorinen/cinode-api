...
if TYPE_CHECKING:
    from ..models.training_item_block_model import TrainingItemBlockModel


T = TypeVar("T", bound="TrainingBlockModel")
...
class TrainingBlockModel:
    ...
    Attributes:
        ...
        data (Union[Unset, None, List['TrainingItemBlockModel']]):
    ...
    data: Union[Unset, None, List["TrainingItemBlockModel"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = TrainingItemBlockModel.from_dict(data_item_data)
