...
T = TypeVar("T", bound="CustomerEventNoteAddEditModel")


@_attrs_define
class CustomerEventNoteAddEditModel:
    """
    Attributes:
        title (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        customer_event_note_add_edit_model = cls(
            title=title,
        ...
        return customer_event_note_add_edit_model
