...
from ..models.company_user_query_sort import CompanyUserQuerySort
from ..models.sort_order import SortOrder
from ..types import UNSET, Unset

T = TypeVar("T", bound="CompanyUserQuerySortPageAndSortByModel")


@_attrs_define
class CompanyUserQuerySortPageAndSortByModel:
    """
    Attributes:
        sort_by (Union[Unset, CompanyUserQuerySort]):
    ...
    sort_by: Union[Unset, CompanyUserQuerySort] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_sort_by, Unset):
            ...
            sort_by = CompanyUserQuerySort(_sort_by)
        ...
        company_user_query_sort_page_and_sort_by_model = cls(
            sort_by=sort_by,
        ...
        return company_user_query_sort_page_and_sort_by_model
