...
T = TypeVar("T", bound="CompanyUserEventMeetingAddEditModel")


@_attrs_define
class CompanyUserEventMeetingAddEditModel:
    """
    Attributes:
        title (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        company_user_event_meeting_add_edit_model = cls(
            title=title,
        ...
        return company_user_event_meeting_add_edit_model
