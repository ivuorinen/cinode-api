...
T = TypeVar("T", bound="DynamicTemplateViewModelPrimaryScriptAssets")


@_attrs_define
class DynamicTemplateViewModelPrimaryScriptAssets:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        dynamic_template_view_model_primary_script_assets = cls(
            none=none,
            primary=primary,
            classic=classic,
            dynamic=dynamic,
        ...
        return dynamic_template_view_model_primary_script_assets
