...
T = TypeVar("T", bound="CustomerEventTaskAddEditModel")


@_attrs_define
class CustomerEventTaskAddEditModel:
    """
    Attributes:
        title (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        customer_event_task_add_edit_model = cls(
            title=title,
        ...
        return customer_event_task_add_edit_model
