...
if TYPE_CHECKING:
    from ..models.company_user_profile_employer_translation_model import CompanyUserProfileEmployerTranslationModel
    from ..models.link import Link


T = TypeVar("T", bound="CompanyUserProfileEmployerModel")


@_attrs_define
class CompanyUserProfileEmployerModel:
    """
    Attributes:
        ...
        translations (Union[Unset, None, List['CompanyUserProfileEmployerTranslationModel']]):
    ...
    translations: Union[Unset, None, List["CompanyUserProfileEmployerTranslationModel"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for translations_item_data in _translations or []:
            translations_item = CompanyUserProfileEmployerTranslationModel.from_dict(translations_item_data)
        ...
        company_user_profile_employer_model = cls(
        ...
        return company_user_profile_employer_model
