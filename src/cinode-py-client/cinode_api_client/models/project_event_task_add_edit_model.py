...
T = TypeVar("T", bound="ProjectEventTaskAddEditModel")


@_attrs_define
class ProjectEventTaskAddEditModel:
    """
    Attributes:
        title (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_event_task_add_edit_model = cls(
            title=title,
        ...
        return project_event_task_add_edit_model
