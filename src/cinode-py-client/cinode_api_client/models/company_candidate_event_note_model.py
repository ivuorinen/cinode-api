...
T = TypeVar("T", bound="CompanyCandidateEventNoteModel")


@_attrs_define
class CompanyCandidateEventNoteModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        company_candidate_event_note_model = cls(
        ...
        return company_candidate_event_note_model
