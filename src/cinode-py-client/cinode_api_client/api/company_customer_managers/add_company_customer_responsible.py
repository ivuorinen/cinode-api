...
from ...models.company_customer_managers_add_edit_model import CompanyCustomerManagersAddEditModel
...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "post",
        "url": "/v0.1/companies/{companyId}/customers/{customerId}/managers".format(
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        ...
        for response_200_item_data in _response_200:
            response_200_item = CompanyCustomerManagerModel.from_dict(response_200_item_data)
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ErrorModel, List['CompanyCustomerManagerModel'], ValidationModel]
    """
