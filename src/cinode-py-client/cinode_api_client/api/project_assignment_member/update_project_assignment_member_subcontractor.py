...
from ...models.project_assignment_member_subcontractor_edit_model import ProjectAssignmentMemberSubcontractorEditModel
...
def _get_kwargs(
    ...
    id: int,
    *,
    json_body: ProjectAssignmentMemberSubcontractorEditModel,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "put",
        "url": "/v0.1/companies/{companyId}/projects/{projectId}/roles/{roleId}/members/subcontractor/{id}".format(
