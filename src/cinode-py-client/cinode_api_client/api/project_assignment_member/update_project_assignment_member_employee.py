...
from ...models.project_assignment_member_employee_edit_model import ProjectAssignmentMemberEmployeeEditModel
...
def _get_kwargs(
    ...
    id: int,
    *,
    json_body: ProjectAssignmentMemberEmployeeEditModel,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "put",
        "url": "/v0.1/companies/{companyId}/projects/{projectId}/roles/{roleId}/members/employee/{id}".format(
