...
from ...models.project_assignment_member_subcontractor_add_model import ProjectAssignmentMemberSubcontractorAddModel
...
def _get_kwargs(
    ...
    role_id: int,
    *,
    json_body: ProjectAssignmentMemberSubcontractorAddModel,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/v0.1/companies/{companyId}/projects/{projectId}/roles/{roleId}/members/subcontractor".format(
