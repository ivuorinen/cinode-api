...
from ...models.project_assignment_edit_model import ProjectAssignmentEditModel
...
def _get_kwargs(
    ...
    id: int,
    *,
    json_body: ProjectAssignmentEditModel,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "put",
        "url": "/v0.1/companies/{companyId}/projects/{projectId}/roles/{id}".format(
