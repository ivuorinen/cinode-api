...
from ...models.project_assignment_add_model import ProjectAssignmentAddModel
...
def _get_kwargs(
    ...
    project_id: int,
    *,
    json_body: ProjectAssignmentAddModel,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/v0.1/companies/{companyId}/projects/{projectId}/roles".format(
