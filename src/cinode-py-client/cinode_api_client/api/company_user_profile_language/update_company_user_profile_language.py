...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "put",
        "url": "/v0.1/companies/{companyId}/users/{companyUserId}/profile/languages/{id}".format(
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = CompanyUserProfileLanguageModel.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, CompanyUserProfileLanguageModel, ErrorModel, ValidationModel]
    """
