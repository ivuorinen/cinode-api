...
from ...models.skill_search_query_term_model import SkillSearchQueryTermModel
...
def _get_kwargs(
    company_id: int,
    *,
    json_body: SkillSearchQueryTermModel,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/v0.1/companies/{companyId}/skills/search/term".format(
