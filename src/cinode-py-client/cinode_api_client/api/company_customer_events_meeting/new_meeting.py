...
from ...models.customer_event_meeting_add_edit_model import CustomerEventMeetingAddEditModel
...
def _get_kwargs(
    ...
    customer_id: int,
    *,
    json_body: CustomerEventMeetingAddEditModel,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/v0.1/companies/{companyId}/customers/{customerId}/events/meetings".format(
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.CREATED:
        response_201 = CustomerEventMeetingModel.from_dict(response.json())
